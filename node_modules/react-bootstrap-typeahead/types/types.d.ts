...
export declare type FilterByCallback = (option: Option, state: TypeaheadPropsAndState) => void;
...
export declare type ShouldSelect = (shouldSelectHint: boolean, event: KeyboardEvent<HTMLInputElement>) => boolean;
export declare type RefElement<T> = T | null;
